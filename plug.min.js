...
e=b.bind({});break;case b instanceof Date:e=new Date,e.setTime(b.getTime())}return e}return{clone:c}})();var t={singleton:function(){var a;return{getInstance:function(c,b){a||(a=c.apply(this,b));return a}}},"transient":function(){return{getInstance:function(a,c){c.unshift(this);return new (Function.prototype.bind.apply(a,c))}}}};m.prototype=function(){return{getValue:function(){var a=this._value;1===this.type&&(a=this._value.getInstance());return a}}}();n.prototype=function(){return{add:function(a,
...
var g=this._factoryStore.retrieve(b),h=this._register.retrieve(c),f=new q(g,f,h);this._register.add(a,1,f);return this}},resolve:function(a){a=this._register.retrieve([].concat(a));if(1==a.length)return a[0].resolution.getValue();for(var c={},b=0;b<a.length;b++){var d=a[b];"undefined"!==typeof d.resolution&&(c[d.name]=d.resolution.getValue())}return c}}}();k.prototype.create=r;(function(){if(!(h.plug&&h.plug instanceof k)){var a=r();h.plug=a}})()})(window,document);
